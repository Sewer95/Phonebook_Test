...
// enter email
    ...
    app.driver.findElement(By.name("email")).sendKeys("shvets.serhii@gmail.com");
// enter password
    app.driver.findElement(By.name("password")).click();
    app.driver.findElement(By.name("password")).clear();
    app.driver.findElement(By.name("password")).sendKeys("Password@123");
...
// Assert that button SignOut is present
  ...
  public void createAccountPositiveTestRefactor() {
    ...
    app.getUserHelper().type(By.name("email"),"shvets_serhii3@gmail.com");
    app.getUserHelper().type(By.name("password"),"Password@123");
  ...
  public void createExistedAccountNegativeTest() {
    ...
    app.getUserHelper().clickLoginLink();
    app.getUserHelper().type(By.name("email"),"shvets_serhii3@gmail.com"); //! Должен быть уже существующий юзер, чтобы перехватывать SoftAssert
    app.getUserHelper().type(By.name("password"),"Password@123");
    app.getUserHelper().click(By.name("registration"));
